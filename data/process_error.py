...
log_path = '/mnt/local/Baselines_Bugs/ColBERT/run_retrieval_1.log'
BASE_DIR = '/mnt/local/Baselines_Bugs/ColBERT/data/repo_data'
RETRIEVAL_DIR = '/mnt/local/Baselines_Bugs/ColBERT/run/retrieve_output'
